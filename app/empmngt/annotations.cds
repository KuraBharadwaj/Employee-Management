...
annotate service.Employees with @(UI.SelectionFields: [emprole_ID, ]);
...
annotate service.Employees with @(UI.FieldGroup #Subsections: {
    $Type: 'UI.FieldGroupType',
    Data : [
        {
            $Type: 'UI.DataField',
...
annotate service.Employees with @(UI.FieldGroup #RoleDetails: {
    $Type: 'UI.FieldGroupType',
    Data : [
        {
            $Type: 'UI.DataField',
